# Marek Witkowski
###  Specjalista do spraw wsparcia IT

e-mail: marek.witkowski.priv@gmail.com

LinkedIn: https://www.linkedin.com/in/marek-witkowski/

GitHub: https://github.com/marek-witkowski


## Technologie

Linux (Ubuntu, Fedora),	Windows Server,	VmWare, 	Java, Python, Oracle,	MS SQL, Git, Docker, WildFly


## Doświadczenie zawodowe

### Specjalista ds. IT, Bank żywności Trójmiasto (wolontariat)-2020-teraz 

* automatyzowanie procesu obiegu informacji (Linux, Python, Postress, MS Excel) - skrócenie czasu wprowadzania dokumentów do systemu z 8 godzin do 15 minut.

### Specjalista ds. koordynacji działu IT, Intra sp. z o.o., Warszawa 		2009-2019

* utrzymywanie środowiska maszyn wirtualnych (Windows Server, Linux) opartego o technologię VMware (5 hostów, 50 maszyn)
* wsparcie użytkowników wewnętrznych (150 osób)
* wsparcie klientów zewnętrznych (4000 podmiotów telefonicznie, 23 podmioty u klienta)
* tworzenie mechanizmów wymiany danych między systemem firmowym a systemami partnerów handlowych (Java, SQL) - osiągnięte 100% bezawaryjnej pracy systemu 
* współpraca z programistami przy ulepszaniu i wdrażaniu nowych wersji oprogramowania

### Testing engineer, Lionbridge,  Warszawa - 2003-2009

* sprawdzanie zgodności zlokalizowanego oprogramowania z oryginałem według podanych specyfikacji (najwięksi klienci: Microsoft, Adobe, Canon)
* wykonywanie testów funkcjonalnych, UI, lokalizacyjnych, regresyjnych, AdHoc
* testowanie zlokalizowanej dokumentacji elektronicznej
* wykonywanie Test QA (sprawdzanie jakości przeprowadzonych testów na danym obszarze oprogramowania)
* wykonywanie Defect QA (sprawdzanie jakości raportów o błędach)
* przygotowywanie środowisk testowych (na komputerach Unix/Linux, PC oraz Mac)
* nadzór nad zasobami wymaganymi przy danym projekcie (utrzymywanie serwerów instalacyjnych, przygotowywanie i aktualizacja środowisk wirtualnych)
* Utrzymanie poziomu jakości powyżej 95% wychwyconych błędów

### QA engineer, Changingworlds, Dublin, Irlandia - 2008-2008

* przygotowywanie środowisk testowych na komputerach Solaris/Linux
* współpraca z programistami (zespół 20 osób)
* testowanie funkcjonalne systemu (Solaris/Java/Oracle)
* tworzenie i modyfikacja scenariuszy testowania
* testowanie aplikacji webowych dla urządzeń mobilnych (system dla 80 mln użytkowników)
* utrzymanie poziomu jakości powyżej 95% - 100%

### Webmaster, Bowne Global Solutions, Warszawa - 2000-2003
* utrzymywanie polskiej części firmowego serwisu WWW
* tworzenie i aktualizowanie firmowego Intranetu 
* tworzenie aplikacji webowych na potrzeby wewnętrzne firmy (ASP, MS SQL)
* wspomaganie działu testowania w pracach związanych z automatyzacją testowania plików HTML
* wspomaganie działu IT w utrzymywaniu systemu


## Wykształcenie

* Warszawska Szkoła Reklamy, Produkcja TV i Filmow - 2008-2010
* Studium fotografii ZPAF - 2006-2007
* Inżynieria oprogramowania, Warszawska Wyższa Szkoła informatyki - 2003-2006
...
* Bootcamp “Programowanie w języku Java”,  Infoshare Academy - 2018-2019
* Kurs programowania Python,  Infoshare Academy - 2019
* STCW - 2019
* SEP 1 kV e - 2019
* Prawo jazdy kat. B - 2011

### Inne osiągnięcia

* Żeglarstwo (licencja: jachtowy sternik morski, SRC, 1500 h, 7000 Nm)- 2015
* Fotografia – Studium Związku Polskich Artystów Fotografików – wystawy zbiorowe: 
  * VI Doroczna Wystawa Studium fotografii ZPAF - 2007 
  * fotoAKTywacja - 2009  
